...
% Markdown support für direktes Einbinden von .md Dateien
\usepackage{markdown}
...
% Diagramme (TikZ / PGF)
%-----------------------------------
% TikZ/PGF: Schematische Vektorgrafiken (Flussdiagramme, Architektur-/UML-/
% Sequenzdiagramme, Gantt-Zeitplan). Vektoriell, skalierbar und typografisch
% konsistent zum Dokument - bevorzugt gegenüber importierten Bitmaps.
% Konvention siehe CLAUDE.md ("Diagrams — prefer TikZ").
\usepackage{tikz}
\usetikzlibrary{shapes.geometric,arrows.meta,positioning,fit,calc}
\usepackage{pgfgantt}% Gantt-Diagramme (z. B. Zeitplan im Exposé)
...
%-----------------------------------
% Automatisches Ausblenden leerer Verzeichnisse (\iffiguresexist etc.)
%-----------------------------------
\input{skripte/leereVerzeichnisse}
...
% HINWEIS: Die folgenden Verzeichnisse (Abbildungen, Tabellen, Abkürzungen,
% Symbole, Glossar) werden automatisch ausgeblendet, wenn sie leer wären -
% inklusive Überschrift, Inhaltsverzeichnis-Eintrag und Seitenumbruch. Die
% Logik dazu steckt in skripte/leereVerzeichnisse.tex (\iffiguresexist,
% \iftablesexist, \ifacronymsused, \ifsymbolsexist, \ifglossaryused).
% Es muss also nichts mehr von Hand auskommentiert werden.
...
% Abkürzungsverzeichnis
%-----------------------------------
% Das acronym-Environment wird immer geladen (Definitionen für \ac{...} im Text).
% Überschrift, TOC-Eintrag und \newpage nur, wenn mindestens eine Abkürzung
...
% Symbolverzeichnis
%-----------------------------------
% In Overleaf führt der Einsatz des Symbolverzeichnisses zu einem Fehler, der aber ignoriert werden kann.
% \input{symbolDef} wird immer geladen (Symbol-Definitionen). Anzeige nur, wenn
% mindestens ein Symbol definiert wurde.
...
% Glossar
%-----------------------------------
% \printnoidxglossaries druckt von sich aus nichts, wenn kein Begriff verwendet
% wurde. Der \newpage entfällt dann, damit keine leere Seite entsteht.
\printnoidxglossaries
\ifglossaryused{\newpage}{}

%-----------------------------------
% KI-Verzeichnis (optional)
%-----------------------------------
% Verzeichnis der eingesetzten KI-Werkzeuge (siehe FOM-Leitfaden). Zum Aktivieren
% die folgende Zeile entkommentieren. Wurde keine KI genutzt, bleibt sie inaktiv.
%\input{kapitel/anhang/ki_verzeichnis}
