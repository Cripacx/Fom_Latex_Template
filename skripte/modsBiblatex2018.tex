...
\renewbibmacro*{cite}{%
  \iffieldundef{shorthand}
    ...
    %Aufgrund der Änderung bzgl des Issues 169 in der main.tex musste ich die Zeile auskommentieren. Konnte aber das Verhalten, dass die Fußnoten grün sind, im nachhinein nicht feststellen.
